...
html_theme_options = {
    "source_repository": "https://github.com/sphinx-notes/comboroles/",
...
html_baseurl = 'https://sphinx.silverrainz.me/comboroles'
...
extlinks = {
    ...
    'pull': ('https://github.com/sphinx-notes/comboroles/pull/%s', '🚀%s'),
    'tag': ('https://github.com/sphinx-notes/comboroles/releases/tag/%s', '🏷️%s'),
}
